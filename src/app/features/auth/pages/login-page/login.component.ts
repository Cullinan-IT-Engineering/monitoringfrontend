  ...
  template: `
    <section class="auth-page">
      <div class="auth-card">
        ...
        <h1>Welcome back</h1>
        <p class="auth-subtitle">Sign in to monitor requests, threats, and alerts in real time.</p>
        ...
        <form class="auth-form" (ngSubmit)="submit()">
          ...
          <label>
            Password
            <input name="password" [(ngModel)]="password" placeholder="Enter your password" type="password" required />
          </label>
